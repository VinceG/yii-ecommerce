...
<section class="grid_12">
	<div class="box">
		<div class="title"><?php echo at('Preview Post'); ?> - <?php echo CHtml::encode($model->title); ?></div>
		<div class='inside'>
			<div class="in">
				<div class="grid_12">
...
<section class="grid_12">
	<div class="box">
		<div class="title"><?php echo $model->isNewRecord ? at('Create Post') : at('Update Post'); ?></div>
		<div class="inside">
			...
			<div class="in">
				<div class="grid_12">
					...
					<div class="grid-9-12">
						...
						<br /><span class="subtip"><?php echo at('Defaults to everyone'); ?></span>
